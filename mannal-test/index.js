(function (global, factory) {
            ...
            var createRequestOptions = function createRequestOptions() {
            ...
            var handleResponse$1 = handleResponse_1.handleResponse,
                handleError$1 = handleResponse_1.handleError;

            var zlFetch = function zlFetch(url, options) {
              var opts = createRequestOptions(Object.assign({
                url: url
              }, options));
              return fetch(opts.url, opts).then(handleResponse$1)["catch"](handleError$1);
            }; // ========================
            // Shorthands
            // ========================
